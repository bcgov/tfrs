...
rem need to load FuelSupplierContacts before FuelSuppliers.
...
call load.bat CreditTradeZeroReason/CreditTradeZeroReason_CTZR.json api/credittradezeroreasons/bulk $1
