...
ModalExtraConfirm.defaultProps = {
...
ModalExtraConfirm.propTypes = {
  ...
  extraConfirmText: PropTypes.string.isRequired,
  extraConfirmType: PropTypes.oneOf([
    'info', 'warning', 'error'
  ]),
  canBypass: PropTypes.bool.isRequired,
