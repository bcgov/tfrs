...
const SecureDocumentSubmissionTable = (props) => {
  const columns = [{
    accessor: 'id',
    className: 'col-id',
    Header: 'ID',
...
SecureDocumentSubmissionTable.defaultProps = {};

SecureDocumentSubmissionTable.propTypes = {
...
export default SecureDocumentSubmissionTable;
