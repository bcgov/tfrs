...
test('ScheduleSummaryContainer should display', () => {
   const props = {
      validationMessages:{},
      scheduleState:{
         summary:{}
...
test('ScheduleSummaryContainer should display with no snapshot', () => {
   const props = {
      validationMessages:{},
      complianceReport:{
         hasSnapshot:true,
...
test('ScheduleSummaryContainer should display loading', () => {
   const props = {
      updateScheduleState: jest.fn(),
      recomputeRequest:jest.fn(),
      validationMessages:{},
