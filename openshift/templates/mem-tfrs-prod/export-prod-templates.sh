...
oc export dc/client service/client route/lowcarbonfuels-frontend route/lowcarbonfuels-notification --as-template='prod-client' --output=json > prod-client.json
oc export dc/tfrs service/backend route/lowcarbonfuels-backend --as-template='prod-api' --output=json > prod-api.json
