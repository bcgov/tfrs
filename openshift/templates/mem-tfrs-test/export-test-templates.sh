...
oc export dc/client service/client route/test-lowcarbonfuels-frontend route/test-lowcarbonfuels-notification  --as-template='test-client' --output=json > test-client.json
oc export dc/tfrs service/backend route/test-lowcarbonfuels-backend --as-template='test-tfrs' --output=json > test-tfrs.json
