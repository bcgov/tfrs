...
const phases = {
  ...
  dev: {namespace:'0ab226-dev'    , name: `${name}`, phase: 'dev'  , changeId:changeId, suffix: `-dev`  , 
        ...
        frontendCpuRequest: '100m', frontendCpuLimit: '700m', frontendMemoryRequest: '300M', frontendMemoryLimit: '4G', frontendReplicas: 1,
            frontendKeycloakAuthority: 'https://dev.oidc.gov.bc.ca/auth/realms/tfrs-dev', frontendKeycloakClientId: 'tfrs-dev', frontendKeycloakCallbackUrl: `https://tfrs-frontend-dev.${ocpName}.gov.bc.ca/authCallback`,
            frontendKeycloakLogoutUrl: `https://logontest.gov.bc.ca/clp-cgi/logoff.cgi?returl=https://tfrs-frontend-dev.${ocpName}.gov.bc.ca`, 
            ...
            backendHost: `tfrs-backend-dev.${ocpName}.gov.bc.ca`, backendReplicas: 1,
            backendKeycloakSaBaseurl: 'https://dev.loginproxy.gov.bc.ca',
            backendKeycloakSaClientId: 'tfrs-on-gold-4308',
            backendKeycloakSaRealm: 'tfrs-on-gold-4308',
