...
const phases = {
  ...
  test: {namespace:'0ab226-test'    , name: `${name}`, phase: 'test'  , changeId:changeId, suffix: `-test`  , 
        ...
        frontendCpuRequest: '20m', frontendCpuLimit: '40m', frontendMemoryRequest: '30Mi', frontendMemoryLimit: '60Mi', frontendReplicas: 1,
        ...
        backendCpuRequest: '30m', backendCpuLimit: '60m', backendMemoryRequest: '150Mi', backendMemoryLimit: '300Mi', backendHealthCheckDelay: 30, 
