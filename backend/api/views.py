...
class fuelsupplierattachmenttagsBulkPost(AuditableMixin, BulkCreateModelMixin,
                                         generics.GenericAPIView):
    """
...
class fuelsupplierattachmenttagsGet(AuditableMixin, mixins.ListModelMixin,
                                    mixins.CreateModelMixin,
                                    generics.GenericAPIView):
    """
...
class fuelsupplierattachmenttagsIdDeletePost(AuditableMixin,
                                             mixins.DestroyModelMixin,
                                             generics.GenericAPIView):
    """
...
class fuelsupplierattachmenttagsIdGet(AuditableMixin, mixins.RetrieveModelMixin,
                                      mixins.UpdateModelMixin,
                                      generics.GenericAPIView):
    """
...
class fuelsuppliersCCDatumBulkPost(AuditableMixin, BulkCreateModelMixin,
                                   generics.GenericAPIView):
    """
...
class fuelsuppliersCCDatumGet(AuditableMixin, mixins.ListModelMixin,
                              mixins.CreateModelMixin, generics.GenericAPIView):
    """
...
class fuelsuppliersCCDatumIdDeletePost(AuditableMixin, mixins.DestroyModelMixin,
                                       generics.GenericAPIView):
    """
...
class fuelsuppliersCCDatumIdGet(AuditableMixin, mixins.RetrieveModelMixin,
                                mixins.UpdateModelMixin,
                                generics.GenericAPIView):
    """
...
class fuelsuppliercontactsBulkPost(AuditableMixin, BulkCreateModelMixin,
                                   generics.GenericAPIView):
    """
...
class fuelsuppliercontactsGet(AuditableMixin, mixins.ListModelMixin,
                              mixins.CreateModelMixin, generics.GenericAPIView):
    """
...
class fuelsuppliercontactsIdDeletePost(AuditableMixin, mixins.DestroyModelMixin,
                                       generics.GenericAPIView):
    """
...
class fuelsuppliercontactsIdGet(AuditableMixin, mixins.RetrieveModelMixin,
                                mixins.UpdateModelMixin,
                                generics.GenericAPIView):
    """
...
class notificationsBulkPost(AuditableMixin, BulkCreateModelMixin,
                            generics.GenericAPIView):
    """
...
class notificationsGet(AuditableMixin, mixins.ListModelMixin,
                       mixins.CreateModelMixin, generics.GenericAPIView):
    """
...
class notificationsIdDeletePost(AuditableMixin, mixins.DestroyModelMixin,
                                generics.GenericAPIView):
    """
...
class notificationsIdGet(AuditableMixin, mixins.RetrieveModelMixin,
                         mixins.UpdateModelMixin, generics.GenericAPIView):
    """
...
class notificationeventsBulkPost(AuditableMixin, BulkCreateModelMixin,
                                 generics.GenericAPIView):
    """
...
class notificationeventsGet(AuditableMixin, mixins.ListModelMixin,
                            mixins.CreateModelMixin, generics.GenericAPIView):
    """
...
class notificationeventsIdDeletePost(AuditableMixin, mixins.DestroyModelMixin,
                                     generics.GenericAPIView):
    """
...
class notificationeventsIdGet(AuditableMixin, mixins.RetrieveModelMixin,
                              mixins.UpdateModelMixin, generics.GenericAPIView):
    """
...
class notificationtypesBulkPost(AuditableMixin, BulkCreateModelMixin,
                                generics.GenericAPIView):
    """
...
class notificationtypesGet(AuditableMixin, mixins.ListModelMixin,
                           mixins.CreateModelMixin, generics.GenericAPIView):
    """
...
class notificationtypesIdDeletePost(AuditableMixin, mixins.DestroyModelMixin,
                                    generics.GenericAPIView):
    """
...
class notificationtypesIdGet(AuditableMixin, mixins.RetrieveModelMixin,
                             mixins.UpdateModelMixin, generics.GenericAPIView):
    """
