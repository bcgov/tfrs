# -*- coding: utf-8 -*-
# Generated by Django 1.11.13 on 2018-08-27 21:14
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0026_notificationchannel_notificationmessage_notificationsubscription'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='channel',
            field=models.CharField(choices=[(NotificationChannel.AvailableChannels('In-Application'), 'IN_APP'), (NotificationChannel.AvailableChannels('SMS'), 'SMS'), (NotificationChannel.AvailableChannels('Email'), 'EMAIL')], max_length=64, unique=True),
        ),
        migrations.AlterField(
