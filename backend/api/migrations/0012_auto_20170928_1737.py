    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CREATE_USER', models.ForeignKey(blank=True, null=True, related_name='api_credittradezeroreason_CREATE_USER', to='api.User')),
                ('UPDATE_USER', models.ForeignKey(blank=True, null=True, related_name='api_credittradezeroreason_UPDATE_USER', to='api.User')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='creditTradeFK',
            field=models.ForeignKey(null=True, related_name='CreditTradeHistorycreditTradeFK', to='api.CreditTrade'),
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, related_name='CreditTradecreditTradeZeroReasonFK', to='api.CreditTradeZeroReason'),
        ),
    ]
