# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-04-08 23:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='energy_density', to='api.UnitOfMeasure'),
        ),
        migrations.AddField(
            model_name='energydensity',
            name='update_user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='api_energydensity_UPDATE_USER', to=settings.AUTH_USER_MODEL),
        ),
    ]
