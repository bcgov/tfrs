...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('server', '0004_auto_20170427_1726'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='userfavourite',
            name='user',
            field=models.ForeignKey(blank=True, to='server.User', related_name='UserFavouriteuser', null=True),
        ),
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(default = 1, related_name='CreditTradeinitiatorLastUpdateBy', to='server.User'),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='credittrade',
            name='respondent',
            field=models.ForeignKey(default = 1, related_name='CreditTraderespondent', to='server.FuelSupplier'),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='credittrade',
        ...
        migrations.AlterField(
            model_name='offer',
            name='fuelSupplier',
            field=models.ForeignKey(default=1, related_name='OfferfuelSupplier', to='server.FuelSupplier'),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='offer',
        ...
        migrations.AlterField(
            model_name='userrole',
            name='role',
            field=models.ForeignKey(default=1, related_name='UserRolerole', to='server.Role'),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='userrole',
            name='user',
            field=models.ForeignKey(default=1, related_name='UserRoleuser', to='server.User'),
            preserve_default=False,
        ),
        migrations.DeleteModel(
