...
class ModalModule extends Module {
   ...
   * @param a custom modal selector to use instead of the generic default. Necessary if multiple modal windows are present on the page. (optional)
   */
  boolean isOpen(modalSelector = modalWindow) {
    return waitFor { modalSelector.displayed }
  }
