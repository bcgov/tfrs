...
class CreditTransferSpec extends GebReportingSpec implements Login {
  def "Log in as the sending fuel supplier and initiate a new credit transfer"() {
  ...
  def "Log in as the receiving fuel supplier and accept the credit transfer"() {
  ...
  def "Log in as an analyst and recommend the credit transfer"() {
  ...
  def "Log in as a Director and recommend the credit transfer"() {
    given: "I am logged in as an Analyst"
      logInAsDirector()
    and: "I populate all required fields to recommend the accepted credit transfer"
      to NotificationsPage
