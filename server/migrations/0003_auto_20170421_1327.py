    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creditTrade', models.ForeignKey(to='server.CreditTrade', related_name='CreditTradeLogEntrycreditTrade')),
                ('newCompliancePeriod', models.ForeignKey(to='server.CompliancePeriod', related_name='CreditTradeLogEntrynewCompliancePeriod')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, auto_created=True, primary_key=True, verbose_name='ID')),
                ('active', models.BooleanField()),
                ('group', models.ForeignKey(to='server.Group', related_name='GroupMembershipgroup')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.CharField(max_length=255)),
                ('creditTrade', models.ForeignKey(to='server.CreditTrade', related_name='NotificationEventcreditTrade')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, auto_created=True, primary_key=True, verbose_name='ID')),
                ('permission', models.ForeignKey(to='server.Permission', related_name='RolePermissionpermission')),
                ('role', models.ForeignKey(to='server.Role', related_name='RolePermissionrole')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(max_length=255)),
                ('active', models.BooleanField()),
                ('permissions', models.ManyToManyField(to='server.PermissionViewModel', related_name='UserDetailsViewModelpermissions')),
            ],
        ),
        migrations.CreateModel(
            name='UserFavourite',
            fields=[
                ...
                ('value', models.CharField(max_length=255)),
                ('isDefault', models.BooleanField()),
                ('User', models.ForeignKey(to='server.User', related_name='UserFavouriteUser')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(to='server.Role', related_name='UserRolerole')),
                ('user', models.ForeignKey(to='server.User', related_name='UserRoleuser')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.BooleanField()),
                ('smUserId', models.CharField(max_length=255)),
                ('groupMemberships', models.ManyToManyField(to='server.GroupMembership', related_name='UserViewModelgroupMemberships')),
                ('userRoles', models.ManyToManyField(to='server.UserRole', related_name='UserViewModeluserRoles')),
            ],
        ),
        ...
        migrations.AddField(
            model_name='user',
            name='fuelSupplier',
            field=models.ForeignKey(to='server.FuelSupplier', related_name='UserfuelSupplier'),
        ),
        migrations.AddField(
            model_name='notification',
            name='event',
            field=models.ForeignKey(to='server.NotificationEvent', related_name='Notificationevent'),
        ),
        migrations.AddField(
            model_name='notification',
            name='user',
            field=models.ForeignKey(to='server.User', related_name='Notificationuser'),
        ),
        migrations.AddField(
            model_name='groupmembership',
            name='user',
            field=models.ForeignKey(to='server.User', related_name='GroupMembershipuser'),
        ),
        migrations.AddField(
            model_name='currentuserviewmodel',
            name='groupMemberships',
            field=models.ManyToManyField(to='server.GroupMembership', related_name='CurrentUserViewModelgroupMemberships'),
        ),
        migrations.AddField(
            model_name='currentuserviewmodel',
            name='userRoles',
            field=models.ManyToManyField(to='server.UserRole', related_name='CurrentUserViewModeluserRoles'),
        ),
        migrations.AddField(
            model_name='credittradelogentry',
            name='user',
            field=models.ForeignKey(to='server.User', related_name='CreditTradeLogEntryuser'),
        ),
        migrations.AddField(
            model_name='credittrade',
            name='approvedRejectedBy',
            field=models.ForeignKey(to='server.User', related_name='CreditTradeapprovedRejectedBy'),
        ),
        migrations.AddField(
            model_name='credittrade',
            name='attachments',
            field=models.ManyToManyField(to='server.Attachment', related_name='CreditTradeattachments'),
        ),
        migrations.AddField(
            model_name='credittrade',
            name='cancelledBy',
            field=models.ForeignKey(to='server.User', related_name='CreditTradecancelledBy'),
        ),
        migrations.AddField(
            model_name='credittrade',
            name='compliancePeriod',
            field=models.ForeignKey(to='server.CompliancePeriod', related_name='CreditTradecompliancePeriod'),
        ),
        migrations.AddField(
            model_name='credittrade',
            name='fuelSupplier',
            field=models.ForeignKey(to='server.FuelSupplier', related_name='CreditTradefuelSupplier'),
        ),
        migrations.AddField(
            model_name='credittrade',
            name='fuelSupplierLastUpdatedBy',
            field=models.ForeignKey(to='server.User', related_name='CreditTradefuelSupplierLastUpdatedBy'),
        ),
        migrations.AddField(
            model_name='credittrade',
            name='history',
            field=models.ManyToManyField(to='server.History', related_name='CreditTradehistory'),
        ),
        migrations.AddField(
            model_name='credittrade',
            name='notes',
            field=models.ManyToManyField(to='server.Note', related_name='CreditTradenotes'),
        ),
        migrations.AddField(
            model_name='credittrade',
            name='partnerLastUpdatedBy',
            field=models.ForeignKey(to='server.User', related_name='CreditTradepartnerLastUpdatedBy'),
        ),
        migrations.AddField(
            model_name='credittrade',
            name='reviewedRejectedBy',
            field=models.ForeignKey(to='server.User', related_name='CreditTradereviewedRejectedBy'),
        ),
        migrations.AddField(
            model_name='credittrade',
            name='transactionPartnerFuelSupplier',
            field=models.ForeignKey(to='server.FuelSupplier', related_name='CreditTradetransactionPartnerFuelSupplier'),
        ),
        migrations.AddField(
            model_name='fuelsupplier',
            name='attachments',
            field=models.ManyToManyField(to='server.Attachment', related_name='FuelSupplierattachments'),
        ),
        migrations.AddField(
            model_name='fuelsupplier',
            name='contacts',
            field=models.ManyToManyField(to='server.Contact', related_name='FuelSuppliercontacts'),
        ),
        migrations.AddField(
            model_name='fuelsupplier',
            name='history',
            field=models.ManyToManyField(to='server.History', related_name='FuelSupplierhistory'),
        ),
        migrations.AddField(
            model_name='fuelsupplier',
            name='notes',
            field=models.ManyToManyField(to='server.Note', related_name='FuelSuppliernotes'),
        ),
        migrations.AddField(
            model_name='fuelsupplier',
            name='primaryContact',
            field=models.ForeignKey(related_name='FuelSupplierprimaryContact', default=1, to='server.Contact'),
            preserve_default=False,
        ),
    ]
